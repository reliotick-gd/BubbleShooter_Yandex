...
namespace CozyAnimalTown
{
    ...
    public static class ScreenColumn
    {
        ...
        // 1.58 — не круглое число, а замеренная граница: боковым панелям нужно место,
        // а ширина сцены растёт вместе с аспектом. На 16:10 (1.6) раскладка помещается
        // целиком, на 3:2 (1.5) счётчик выстрелов уже налезает на доску, на 4:3 панели
        // перекрывают поле наполовину. Раньше порог был 1.15, и всё в диапазоне
        // 1.15-1.6 рисовалось поверх доски и частично за краем экрана.
        //
        // Что ниже порога — идёт в портретную колонку. Полей-заливки там больше нет:
        // основная камера полноэкранная, и по бокам виден игровой фон (см. CameraFitter),
        // так что п.5.9 это не нарушает.
        public const float WideThreshold = 1.58f;     // с какого аспекта экрана считаем «широким»
